...
const CreatePage = () => {
    ...
    const handlePageSubmit = async (e) => {
        ...
        const dataSet = {
            ...
            "status_id": allStatus && allStatus._id,
        }

        try {
            const res = await axiosInstance.post(`${process.env.NEXT_PUBLIC_API_URL}${process.env.NEXT_PUBLIC_API_SLUG}/create-privacyandpolicy `, dataSet);
            console.log(res && res.data && res.data)
            if (res && res.data && res.data.success === true) {
                _SUCCESS("Page created successfully");
