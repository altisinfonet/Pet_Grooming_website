...
const PageTermsAndCondition = () => {
    ...
    async function getAllStatus() {
        try {
            const res = await axiosInstance.get(`${process.env.NEXT_PUBLIC_API_URL}${process.env.NEXT_PUBLIC_API_SLUG}/get-termsofuse`);
    ...
    const handleDeleteClick = async (id) => {
        ...
        try {
            const res = await axiosInstance.post(`${process.env.NEXT_PUBLIC_API_URL}${process.env.NEXT_PUBLIC_API_SLUG}/delete-termsofuse`, { "_id": id });
            ...
            <CCard className="mb-4">
                <CCardHeader>
                    ...
                    <div className=" d-flex justify-content-between">
                        <div>
                            <strong>Page Terms and Condition</strong>
                        </div>
                    </div>
                </CCardHeader>
                    ...
                    <div className='totalAdd'>
                        {
                            allPageTermsAndCondition.length === 0 ?
                                <Button type="button" className="fcbtn1" onClick={() => router.push("/admin/page-terms-and-condition/create-page-terms-and-condition")}>
                                        ...
                                        <tr key={res._id}>
                                            ...
                                            <td>
                                                <div className="d-flex ai-justify-content-end" style={{ gap: 10 }}>
                                                    <i className="fa-solid fa-pen-to-square edit edit-text-color cursor-pointer" onClick={() => router.push(`/admin/page-terms-and-condition/update-page-terms-and-condition?id=${res._id}`)}></i>
