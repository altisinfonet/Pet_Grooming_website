...
const CreatePageTermsAndCondition = () => {
    ...
    const handlePageSubmit = async (e) => {
        ...
        try {
            const res = await axiosInstance.post(`${process.env.NEXT_PUBLIC_API_URL}${process.env.NEXT_PUBLIC_API_SLUG}/create-termsofuse`, dataSet);
    ...
    return (
        <CCard>
            <CCardHeader>
                <strong>Create Terms and Condition</strong>
            </CCardHeader>
...
export default CreatePageTermsAndCondition