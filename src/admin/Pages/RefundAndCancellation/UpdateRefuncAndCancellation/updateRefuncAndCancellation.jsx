...
const UpdateRefuncAndCancellation = () => {
  ...
  useEffect(() => {
    async function getAllStatus() {
      if (router.isReady && router && router.query.id) {
        try {
          const res = await axiosInstance.post(`${process.env.NEXT_PUBLIC_API_URL}${process.env.NEXT_PUBLIC_API_SLUG}/getbyid-cancellationandrefund`, { _id: router && router.query.id });
  ...
  const handlePageSubmit = async (e) => {
    ...
    try {
      const res = await axiosInstance.post(`${process.env.NEXT_PUBLIC_API_URL}${process.env.NEXT_PUBLIC_API_SLUG}/update-cancellationandrefund`, dataSet);
...
export default UpdateRefuncAndCancellation