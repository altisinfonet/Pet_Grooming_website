...
export default function PaymentPage() {
    ...
    return (
        <>
            <MetaHead title={"Paymet"} description={"PinkPaws Grooming"} />
            <div className="container">
                <h1 className="h3 mb-5">Payment (under development)</h1>
                <div className="row">
                    {/* <!-- Left --> */}
                    ...
                    <div className="col-lg-3">
                        <div className="card position-sticky top-0">
                            <div className="p-3 bg-light bg-opacity-10">
                                ...
                                <button type="button" onClick={() => navigate("/thankyou")} className="btn btn-primary w-100 mt-2">Place order</button>
                            </div>
                        </div>
                    </div>
                </div>
